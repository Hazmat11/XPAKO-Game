    ...
    private void newBalls (int nbBalls)
    {
        switch (nbBalls)
        {
            case 1 :
                ...
                spawn1 = Instantiate(ballsPrefabs[/*IndexBalls[0]*/ 0], pos1, gameObject.transform.rotation);
            ...
            case 2 :
                ...
                spawn2 = Instantiate(ballsPrefabs[0], pos2, gameObject.transform.rotation);
            ...
            case 3 :
                ...
                spawn3 = Instantiate(ballsPrefabs[0], pos3, gameObject.transform.rotation);
            ...
            case 4 :
                ...
                spawn4 = Instantiate(ballsPrefabs[0], pos4, gameObject.transform.rotation);
